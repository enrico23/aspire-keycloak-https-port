...
This initial version establishes the baseline Aspire 
solution structure.  

## Related discussion

- Upstream issue: *(link to the GitHub issue once you add it)*

## Disclaimer

This is not an official Aspire extension.  
Any workaround implemented here is temporary 
and may rely on current Aspire implementation details.
